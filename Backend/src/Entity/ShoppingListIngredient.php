...
class ShoppingListIngredient
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Ingredient", inversedBy="shoppingListIngredients", fetch="EAGER")
     */
    private $ingredient;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ShoppingList", inversedBy="shoppingListIngredients", fetch="EAGER")
     */
