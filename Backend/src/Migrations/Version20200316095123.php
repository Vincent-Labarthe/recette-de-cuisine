 ...
 */
final class Version20200316095123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6BAF787054963938 ON ingredient');
        $this->addSql('ALTER TABLE ingredient DROP api_id');
        ...
        $this->addSql('ALTER TABLE shopping_list_ingredient CHANGE ingredient_id ingredient_id INT DEFAULT NULL, CHANGE shopping_list_id shopping_list_id INT DEFAULT NULL, CHANGE amount amount DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD api_id INT NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6BAF787054963938 ON ingredient (api_id)');
        $this->addSql('ALTER TABLE recipe CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE shopping_list CHANGE user_id user_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE shopping_list_ingredient CHANGE ingredient_id ingredient_id INT DEFAULT NULL, CHANGE shopping_list_id shopping_list_id INT DEFAULT NULL, CHANGE amount amount NUMERIC(10, 1) NOT NULL');
